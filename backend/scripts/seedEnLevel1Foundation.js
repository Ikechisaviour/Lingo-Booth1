/**
 * seedEnLevel1Foundation.js
 * Idempotent upsert of the English Level 1 Foundation (phonics / IPA) lesson.
 * Matches by { title, targetLang } so re-runs replace in place.
 *
 * Usage: node scripts/seedEnLevel1Foundation.js
 */

const mongoose = require('mongoose');
const Lesson = require('../models/Lesson');
const level1Foundation = require('../textbookLessons/en/level1Foundation');
