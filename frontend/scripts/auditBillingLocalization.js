...
const LATIN_PLAN_NAMES = {
  ...
  pro: 'Pro',
  ultra: 'Premium',
  institution_basic: 'Institution Plus',
  institution_pro: 'Institution Pro',
  institution_enterprise: 'Institution Premium',
};
...
const SOUND_PLAN_NAMES_BY_LOCALE = {
  ar: {
    ...
    pro: 'برو',
    ultra: 'بريميوم',
    institution_basic: 'إنستيتيوشن بلس',
    institution_pro: 'إنستيتيوشن برو',
    institution_enterprise: 'إنستيتيوشن بريميوم',
  },
  bn: {
    free: 'ফ্রি',
    plus: 'প্লাস',
    pro: 'প্রো',
    ultra: 'প্রিমিয়াম',
    institution_basic: 'ইনস্টিটিউশন প্লাস',
    institution_pro: 'ইনস্টিটিউশন প্রো',
    institution_enterprise: 'ইনস্টিটিউশন প্রিমিয়াম',
  },
  he: {
    free: 'פרי',
    plus: 'פלוס',
    pro: 'פרו',
    ultra: 'פרימיום',
    institution_basic: 'אינסטיטיושן פלוס',
    institution_pro: 'אינסטיטיושן פרו',
    institution_enterprise: 'אינסטיטיושן פרימיום',
  },
  hi: {
    free: 'फ्री',
    plus: 'प्लस',
    pro: 'प्रो',
    ultra: 'प्रीमियम',
    institution_basic: 'इंस्टिट्यूशन प्लस',
    institution_pro: 'इंस्टिट्यूशन प्रो',
    institution_enterprise: 'इंस्टिट्यूशन प्रीमियम',
  },
  ja: {
    free: 'フリー',
    plus: 'プラス',
    pro: 'プロ',
    ultra: 'プレミアム',
    institution_basic: 'インスティテューション プラス',
    institution_pro: 'インスティテューション プロ',
    institution_enterprise: 'インスティテューション プレミアム',
  },
  ko: {
    free: '프리',
    plus: '플러스',
    pro: '프로',
    ultra: '프리미엄',
    institution_basic: '인스티튜션 플러스',
    institution_pro: '인스티튜션 프로',
    institution_enterprise: '인스티튜션 프리미엄',
  },
  ru: {
    free: 'Фри',
    plus: 'Плюс',
    pro: 'Про',
    ultra: 'Премиум',
    institution_basic: 'Инститьюшн Плюс',
    institution_pro: 'Инститьюшн Про',
    institution_enterprise: 'Инститьюшн Премиум',
  },
  ta: {
    free: 'ஃப்ரீ',
    plus: 'பிளஸ்',
    pro: 'ப்ரோ',
    ultra: 'ப்ரீமியம்',
    institution_basic: 'இன்ஸ்டிட்யூஷன் பிளஸ்',
    institution_pro: 'இன்ஸ்டிட்யூஷன் ப்ரோ',
    institution_enterprise: 'இன்ஸ்டிட்யூஷன் ப்ரீமியம்',
  },
};
